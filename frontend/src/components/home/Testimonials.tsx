...
// Correction : Accéder à la propriété .default si elle existe (problème courant avec Vite et react-slick)
...
const TestimonialCard = ({ parent, role, text }: any) => (
  <div className="relative mx-4 h-full group">
    {/* Effet de reflet premium */}
